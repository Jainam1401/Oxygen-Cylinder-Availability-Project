...
public class Customer_Registration extends javax.swing.JFrame {
    ...
    public Customer_Registration() {
        initComponents();
        setDefaultCloseOperation(Customer_Registration.DISPOSE_ON_CLOSE);
        dispose();
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Contact_No_Textfield))
                .addGap(40, 40, 40)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        else
        {
            try
            {
                ...
                int i = st.executeUpdate("insert into customer_details values('"+username+"','"+Email+"','"+password+"','"+City+"','"+pincode+"','"+Contact_no+"')");
