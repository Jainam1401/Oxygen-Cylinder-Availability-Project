 ...
 * @author Ruchi Patel
 */
public class Update_Supplier_Account extends javax.swing.JFrame {

    /**
     * Creates new form Update_Customer_Account
     */
    public Update_Supplier_Account(String name,String email) {
        initComponents();
        setDefaultCloseOperation(Update_Supplier_Account.DISPOSE_ON_CLOSE);
        dispose();
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        else
        {
            try
            {
                ...
                int i = st.executeUpdate("update supplier_details set Username = '"+username+"' , Email = '"+Email+"' , Password = '"+password+"' , City = '"+City+"' , Pincode = '"+pincode+"' , Contact_No = '"+Contact_no+"' where Email = '"+Email1+"' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Supplier_Account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
