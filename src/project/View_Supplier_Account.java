 ...
 * @author Ruchi Patel
 */
public class View_Supplier_Account extends javax.swing.JFrame {

    /**
     * Creates new form View_Customer_Account
     */
    public View_Supplier_Account(String name,String email) {
        initComponents();
        setDefaultCloseOperation(View_Supplier_Account.DISPOSE_ON_CLOSE);
        dispose();
        ...
        try
        {
            ...
            ResultSet rs = st.executeQuery("select * from supplier_details where Email='"+Email+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Supplier_Account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
